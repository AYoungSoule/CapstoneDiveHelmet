...
BRA = sum(BRA)/len(BRA) #This is the list and average of said list that will be used to determine the average breathing rate of the user which helps tell how much time is left in trip
ROT = O2V/3 
DT = ROT
ER = ROT
